...
state-machine transformation: each suspend function is compiled into a state machine. This approach adds
generated code that increases binary size and introduces runtime overhead.
