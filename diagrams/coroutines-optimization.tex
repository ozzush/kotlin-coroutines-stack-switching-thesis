...
% -------------------------
    ...
    \node[whiteNote, text width=8em] (n2_2) at (5, -17.5) {put Wasm\\continuation in \texttt{Continuation}};
...
% -------------------------
    \node[whiteNote, font=\scriptsize, text width=5em] (n4_1) at (14.5, -7) {*create\\\texttt{Continuation}\\which does\\nothing on\\resume*};
    ...
    \node[decision, font=\scriptsize] (n4_4) at (14.5, -13.5) {\texttt{Continuation}\\was resumed\\in lambda};
...
% -------------------------
    ...
    \draw[arrow] (n4_5.south) |- node[above, pos=0.75, font=\scriptsize] {pass \texttt{Continuation}} (n2_2.east);
