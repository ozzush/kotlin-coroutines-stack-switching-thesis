...
% -------------------------
    ...
    % Note below n8
    \node[note] (n9) at (7, -9.5) {*execute\\fun body*};

    % Note below n9
    \node[note] (n10) at (7, -12) {\texttt{return}};
