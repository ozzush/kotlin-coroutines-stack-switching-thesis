...
% -------------------------
    ...
    \node[note] (n3) at (0, -6.5) {\texttt{return\\COROUTINE\_\\SUSPENDED}};
    \node[note, text width=7em] (n4) at (0, -13) {\texttt{completion\\.resume(result)}};

% -------------------------
% Right Column Nodes
% -------------------------
    \node[note] (n6) at (7, -4) {*execute\\suspendFun\\body*};
...
% Container Box for suspendCoroutine
    ...
    \node[note, text width=10em] (n7_note) at (7, -7) {*call \texttt{suspend-}\\\texttt{Lambda(continuation)}*};

    \node[note] (n8) at (7, -10) {*continue\\execution*};
