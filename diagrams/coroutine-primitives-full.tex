\begin{tikzpicture}[
    ...
    title/.style={font=\large\bfseries, text width=16em, align=center},
...
% -------------------------
    ...
    \node[yellowNote] (n2_2) at (6, -9.5) {Coroutine suspended};
    \node[yellowNote] (n2_3) at (6, -14.5) {resume\\completion\\with result};

% -------------------------
% Column 3 Nodes
% -------------------------
    \node[yellowNote] (n3_1) at (12, -4.5) {*execute\\suspend\\fun code*};
    \node[pinkNote, font=\scriptsize, minimum height=2em, text width=8em] (n3_2) at (12, -7) {\texttt{suspendCoroutine-\\UninterceptedOrReturn}};
    \node[yellowNote] (n3_3) at (12, -12) {*continue\\execution*};
    \node[yellowNote] (n3_4) at (12, -14.5) {return\\result};
