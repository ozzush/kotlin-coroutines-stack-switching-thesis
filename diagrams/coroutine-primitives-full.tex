...
% Column 1 Nodes
% -------------------------
    \node[whiteNote, text width=7em] (n1_1) at (0, -2) {create\\\texttt{CoroutineImpl}};
...
% Column 3 Nodes
% -------------------------
    \node[note] (n3_1) at (12, -4.5) {*suspend fun executes*};
    \node[pinkNote, minimum height=2em, text width=10em] (n3_2) at (12, -7) {\texttt{suspendCoroutine-\\UninterceptedOr-\\Return(suspendLambda)}};
    \node[note] (n3_3) at (12, -12) {*execution continues*};
    \node[note] (n3_4) at (12, -14.5) {return result};

% -------------------------
% Column 4 Nodes
% -------------------------
    \node[whiteNote, text width=13em] (n4_1) at (18, -7) {\texttt{suspendLambda(continuation)}};
