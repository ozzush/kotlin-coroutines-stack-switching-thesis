\begin{tikzpicture}[
    ...
    yellowNote/.style={rectangle, draw, fill=yellow!15, text width=6em, text centered, rounded corners, minimum height=2.5em},
    pinkNote/.style={rectangle, draw, fill=orange!10, text width=6em, text centered, rounded corners, minimum height=2.5em},
    bgBox/.style={rectangle, draw=gray!50, fill=gray!5, rounded corners, inner sep=0.5cm},
...
% -------------------------
    \node[title] (t1) at (0, 0) {\texttt{startCoroutineUninterceptedOrReturn}};
    \node[title] (t2) at (4.5, 0) {\texttt{CoroutineImpl::resumeWith}};
    \node[title] (t3) at (9, 0) {suspend function};
    \node[title] (t4) at (13.5, 0) {\texttt{suspendCoroutineUninterceptedOrReturn}};

% -------------------------
% Column 1 Nodes
% -------------------------
    \node[whiteNote, text width=7em] (n1_1) at (0, -2) {*create\\CoroutineImpl*};
    \node[yellowNote, text width=10em] (n1_2) at (0, -4.5) {\texttt{CoroutineImpl::\\resumeWith(Unit)}};
...
% Column 2 Nodes
% -------------------------
    \node[pinkNote] (n2_1) at (4.5, -4.5) {\texttt{doResume()}};
    \node[yellowNote] (n2_2) at (4.5, -9.5) {Coroutine suspended};
    \node[yellowNote] (n2_3) at (4.5, -14.5) {resume\\completion\\with result};

% -------------------------
% Column 3 Nodes
% -------------------------
    \node[yellowNote] (n3_1) at (9, -4.5) {*execute\\suspend\\fun code*};
    \node[pinkNote, font=\scriptsize, minimum height=2em, text width=15em] (n3_2) at (9, -7) {\texttt{suspendCoroutineUninterceptedOrReturn}};
    \node[yellowNote] (n3_3) at (9, -12) {*continue\\execution*};
    \node[yellowNote] (n3_4) at (9, -14.5) {return\\result};

% -------------------------
% Column 4 Nodes
% -------------------------
    \node[whiteNote] (n4_1) at (13.5, -7) {*execute\\suspend\\lambda*};

    % The branching paths below the lambda execution
    \node[whiteNote, text width=6.5em] (n4_2) at (11.5, -9.5) {result is\\\texttt{COROUTINE\_\\SUSPENDED}};
    \node[whiteNote, text width=6.5em] (n4_3) at (15.5, -9.5) {result is\\a value};
...
% -------------------------
    \begin{pgfonlayer}{background}
        ...
        \coordinate (c4_top) at (13.5, 0.8);
        \coordinate (c4_bot) at (13.5, -15.5);
