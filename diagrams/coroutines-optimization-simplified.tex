...
% -------------------------
    \node[whiteNote, font=\scriptsize, text width=7em] (n4_1) at (4.5, -5) {*create\\\texttt{WasmContinuation}\\which does\\nothing on\\resume*};
    ...
    \node[decision, font=\scriptsize] (n4_4) at (4.5, -11) {\texttt{WasmContinuation}\\was resumed\\in lambda};
