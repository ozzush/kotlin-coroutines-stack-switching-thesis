\begin{tikzpicture}[
    ...
    blueNote/.style={rectangle, draw, fill=blue!20, text width=6em, text centered, rounded corners, minimum height=2.5em},
    yellowNote/.style={rectangle, draw, fill=yellow!20, text width=6em, text centered, rounded corners, minimum height=2.5em},
...
% -------------------------
    ...
    \draw[thick] (10, 1.5) -- (10, -19.5); % Vertical line
...
% -------------------------
    ...
    \node[whiteNote, text width=9em] (n1_3) at (0, -13) {return\\\texttt{COROUTINE\_\\SUSPENDED}};
    \node[whiteNote] (n1_4) at (0, -18) {return\\value};
...
% -------------------------
    ...
    \node[whiteNote, font=\scriptsize, text width=7em] (fork_l) at (4.5, -13) {suspendLambda\\returned\\\texttt{COROUTINE\_\\SUSPENDED}};

    % Right Branch (X=7.5, centered around column)
    \node[whiteNote, font=\scriptsize, text width=7em] (fork_r) at (7.5, -13) {suspendLambda\\returned a value};

    \node[blueNote] (n2_2) at (6, -15.5) {\texttt{resume}};
...
% -------------------------
    ...
    % Container Box
    \node[container, minimum width=11em, minimum height=6em] (box) at (13.5, -8.5) {};
    ...
    \node[blueNote, font=\scriptsize, minimum height=2em, text width=7em] (n3_2) at (13.5, -9) {\texttt{suspend}};

    \node[yellowNote] (n3_3) at (13.5, -15.5) {*continue\\execution*};
    \node[yellowNote] (n3_4) at (13.5, -18) {return\\value};
