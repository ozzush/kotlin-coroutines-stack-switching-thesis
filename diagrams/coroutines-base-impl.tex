...
% -------------------------
    ...
    \node[subtitle, text width=13em] (sub2) at (6, -1) {\texttt{WasmContinuation::doResume}};
...
% -------------------------
    ...
    \node[yellowNote, text width=10em] (n1_2) at (0, -5.5) {\texttt{WasmContinuation::\\resumeWith(Unit)}};
...
% -------------------------
    ...
    \node[whiteNote, font=\scriptsize, text width=5em] (fork_r) at (7.5, -10.5) {suspendLambda\\returned a value};
