...
\newcommand{\WasmContinuation}{\texttt{WasmContinuation}\xspace}
\newcommand{\startCoroutineUninterceptedOrReturn}{\texttt{startCoroutineUninterceptedOrReturn}\xspace}
\newcommand{\suspendCoroutineUninterceptedOrReturn}{\texttt{suspendCoroutineUninterceptedOrReturn}\xspace}
\newcommand{\createCoroutineUnintercepted}{\texttt{createCoroutineUnintercepted}\xspace}
\newcommand{\COROUTINESUSPENDED}{\texttt{COROUTINE\_SUSPENDED}\xspace}
\newcommand{\Continuation}{\texttt{Continuation}\xspace}
\newcommand{\CoroutineImpl}{\texttt{CoroutineImpl}\xspace}
\newcommand{\resumeWith}{\texttt{resumeWith}\xspace}
\newcommand{\doResume}{\texttt{doResume}\xspace}
\newcommand{\contnew}{\texttt{cont.new}\xspace}
\newcommand{\wasmresume}{\texttt{resume}\xspace}
\newcommand{\wasmsuspend}{\texttt{suspend}\xspace}
